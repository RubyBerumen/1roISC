...
public class Ejemplo_Ciclo_cadenas {

	public static void main(String[] args) {
		
		System.out.println("Programa que simula el juego del ahorcado donde el segundo jugador"
				+ "es la computadora\n");
		...
		do {
			...
			if (ascii==49) {
				...
				String palabras[] =
				{"PROGRAMACION","OBJETOS","FUNDAMENTOS","CLASE","METODO","ATRIBUTO","JAVA",
						"PYTHON","INSTANCIA","ORIENTADA"};
				String palabraAleatoria = palabras[rnd.nextInt(10)];
				...
				String palabras1[] =
				{"PROGRAMING","OBJECTS","FUNDAMENTS","CLASS","METHOD","ATTRIBUTE","JAVA",
					"PYTHON","INSTANCE","ORIENTED"};
				String palabraAleatoria1 = palabras1[rnd.nextInt(10)];
				System.out.println (palabraAleatoria1);
