...
public class Ej_02_NumerosComplejos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ingresa la parte real del primer número:");
		int parteReal1 = ent.nextInt();
		ent.nextLine();
		System.out.println("Ingresa la parte imaginaria del primer número:");
		String parteImaginaria1 = ent.nextLine();
		System.out.println("Ingresa la parte real del segundo número:");
		int parteReal2 = ent.nextInt();
		ent.nextLine();
		System.out.println("Ingresa la parte imaginaria del segundo número:");
